...
export const getSmallShapes = (sectionSize) => [
  {
    ...
    animate: { y: window.innerHeight - sectionSize.width / 1.02 },
    transition: {
      duration: 1,
      type: "spring",
      damping: 15,
  ...
  },
  {
    ...
    style: { width: "100vw" },
    initial: { y: -850, x: 0 },
    animate: { y: window.innerHeight - sectionSize.width / 1.134 },
    transition: {
      duration: 1,
      type: "spring",
      damping: 15,
  ...
  },
  {
    ...
    animate: {
      y: window.innerHeight - sectionSize.width * 0.535,
    },
    transition: {
      duration: 1,
      type: "spring",
  ...
  },
  {
    ...
    initial: { y: -500, x: "0vw" },
    animate: {
      y: window.innerHeight - sectionSize.width / 0.842,
    },
    transition: {
      duration: 1,
      type: "spring",
