...
export const getSmallShapes = (sectionSize) => [
  {
    ...
    animate: { y: sectionSize.height - sectionSize.width / 1.18 - 55 },
    transition: {
      duration: 1,
      type: "spring",
      damping: 15,
  ...
  },
  {
    ...
    style: { width: "100vw" },
    initial: { y: -850, x: 0 },
    animate: { y: sectionSize.height - sectionSize.width / 1.325 - 55 },
    transition: {
      duration: 1,
      type: "spring",
      damping: 15,
  ...
  },
  {
    ...
    animate: {
      y: sectionSize.height - sectionSize.width * 0.405 - 55,
    },
    transition: {
      duration: 1,
      type: "spring",
  ...
  },
  {
    ...
    initial: { y: -500, x: "0vw" },
    animate: {
      y: sectionSize.height - sectionSize.width / 0.95 - 55,
    },
    transition: {
      duration: 1,
      type: "spring",
