...
var mailList = ["michael.babin@griffincreative.ca", "fdgkj@sdkfjkfd.ca"];
...
exports.handler = async (event) => {
  ...
  const emailSubject = "NewsLetter Experience";
  const data = {
    from: from,
    to: mailList,
                                                            ...
                                                            <table width="460" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <p style="font-family:'Poppins',sans-serif;font-size:15px;font-weight:300;line-height:24px;color:#656465;text-align:justify;">Vous avez reçu une demande d'inscription à la newsletter.
                                                                            <ul>
                                                                                <li>Nom: ${name} </li>
